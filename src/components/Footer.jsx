...
const socials = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/godwin-tairo-4977a727b?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/godwin105',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'X / Twitter',
    href: 'https://x.com/GrowthGrid_105',
    icon: (
